...
#### Mode Discipline — You Are NOT (BUILDER)
...
#### Key Questions to Ask in This Mode (BUILDER)
...
#### Mode Discipline — You Are NOT (DEBUGGER)
...
#### Key Questions to Ask in This Mode (DEBUGGER)
...
#### Mode Discipline — You Are NOT (REVIEWER)
...
#### Key Questions to Ask in This Mode (REVIEWER)
...
#### Mode Discipline — You Are NOT (DESIGNER)
...
#### Key Questions to Ask in This Mode (DESIGNER)
...
#### Mode Discipline — You Are NOT (SECURITY)
...
#### Key Questions to Ask in This Mode (SECURITY)
...
#### Mode Discipline — You Are NOT (PERFORMANCE)
...
#### Key Questions to Ask in This Mode (PERFORMANCE)
...
#### Mode Discipline — You Are NOT (RESEARCH)
...
#### Key Questions to Ask in This Mode (RESEARCH)
...
#### Mode Discipline — You Are NOT (OPTIMIZER)
...
#### Mode Discipline — You Are NOT (TEACHER)
...
#### Key Questions to Ask in This Mode (TEACHER)
