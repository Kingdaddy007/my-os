...
2. **If `contexts/research-brief.md` exists → read for audience, competitors, positioning**

3. **If `PRODUCT.md` exists → read for register, brand personality, anti-references**

4. **Then check for product marketing context:**
...
5. **Only ask questions for information not covered by the above**
