...
**Motion Standard:** `motion` (modern Framer Motion) is mandatory in every project. `npm install motion` before writing motion code. See Layer 2 > Motion for principles.
