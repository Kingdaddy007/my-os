...
> **IMPORTANT [REQUIRED]:** This is the UI Trigger. For the full detailed logic, instructions, and implementation phases, the Agent MUST load and follow the [SOURCE FILE](file:///c:/Users/Oviks/antigravity/workflows/workflow-project-inception.md).
...
- [ ] **Load Source [REQUIRED]:** [workflow-project-inception.md](file:///c:/Users/Oviks/antigravitygold/workflows/workflow-project-inception.md) (Follow all 6 phases).
