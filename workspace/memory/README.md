...
| :--- | :--- | :--- | :--- |
| 1 | [decisions-log.md](file:///c:/Users/Oviks/antigravitygold/memory/decisions-log.md) | Significant technical decisions and their reasoning | After any Type 1 or Type 1.5 decision |
| 2 | [common-patterns.md](file:///c:/Users/Oviks/antigravitygold/memory/common-patterns.md) | Reusable patterns that work well in this project | When a pattern proves valuable across three or more uses |
| 3 | [mistakes-to-avoid.md](file:///c:/Users/Oviks/antigravitygold/memory/mistakes-to-avoid.md) | Mistakes that have been made and their root causes | After any bug, incident, or architectural mistake |
| 4 | [benchmark-results.md](file:///c:/Users/Oviks/antigravitygold/memory/benchmark-results.md) | Anti-Gravity performance scores over time | After running benchmark tests |
| 5 | [postmortems.md](file:///c:/Users/Oviks/antigravitygold/memory/postmortems.md) | Post-incident analysis and lessons learned | After P1 or P2 incidents |
| 6 | [version-notes.md](file:///c:/Users/Oviks/antigravitygold/memory/version-notes.md) | Changes to the Anti-Gravity system itself | When core, skills, or workflows are updated |
