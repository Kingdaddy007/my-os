...
- Questions like "What is the best way to…" where the answer depends on context and tradeoffs
...
- Always consider the boring baseline:
  - stay with the current system
  - use the standard default
  - delay the decision
  - solve it with existing tooling
  - do less
