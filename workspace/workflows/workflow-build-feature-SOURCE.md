...
- [REQUIRED] Load [feature-plan.md](file:///c:/Users/Oviks/antigravitygold/templates/feature-plan.md)
...
### STEP 11 — POST-SHIP (when applicable)
...
4. Update `memory/decisions-log.md` if significant architectural decisions were made
5. Update relevant context files if conventions or patterns changed
